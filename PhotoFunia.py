...
### EFECT LIST THREE ###
def photofunia3():
    category_list = ['broadway-at-night', 'painter', 'new-york-at-night', 'posters-on-the-wall', 'festive-days', 'old-tram', 'portrait-gallery', 'bronze-frames', 'summer-diary', 'urban-billboard', 'billboards-at-night', 'shop-posters', 'roller-shutters', 'black-white-gallery', 'four-billboards', 'top-secret', 'campaign', 'museum-banners', 'five_paintings', 'antique_shop', 'gallery_of_art', 'art_book', 'london_gallery', 'new_year_tree', 'queens_theatre', 'painter_on_the_bridge', 'streets_of_new_york', 'reading_on_the_balcony', 'copying_masterpiece', 'taxis_on_times_square', 'interview', 'summer_love', 'vue', 'genova', 'photobooth', 'reading', 'national_gallery', 'photo_exhibition', 'nyc_billboards', 'cyclist', 'at_the_mirror', 'night_square', 'underground', 'times_square', '3_shop_posters', 'smart_kitty', 'broken_glass', 'brick_wall', 'stamps', 'modern_art', 'grieder', 'under_the_heel']
    if api_key == "INSERT API KEY HERE":
        print("GET API KEY FROM LINE ID: hertot")
        raise Exception("Wrong API Key")
    print(category_list)
...
### EFECT LIST FOUR ###
def photofunia4():
    category_list = ['rijskmuseum', 'morning-newspaper', 'easter-greetings', 'christmas-diary', 'golden-coin', 'autumn-leaf', 'activists', 'coffee-and-tulips', 'night-street', 'rose-vine', 'travellers-diary', 'festive-greetings', 'xmas-time', 'festive-reading', 'missing-person', 'the-book', 'business-newspaper', 'vinyl-store', 'square-billboard', 'easter-nest', 'open-book', 'two-valentines', 'champagne', 'snow-globe', 'travelers-suitcase', 'morning-mug', 'spy-dossier', 'very-old-book', 'hanging-billboard', 'easter-card', 'santas-parcel-picture', 'clapperboard', 'double-decker', 'breaking-news', 'cookbook', 'vinyl-record', 'book_lover', 'new_world', 'quill', 'classic_book', 'easter_postcard', 'daffodils', 'memories_of_paris', 'card_with_laces', 'christmas_tree', 'on_the_bike', 'bottle_of_wine', 'together_forever', 'morning_news', 'resident_evil_barry', 'making_tattoo', 'instant_camera', 'another_magazine', 'pink_heart', 'fbi_agent', 'new_year_presents', 'miss', 'theatre', 'affiche', 'rounded_billboard', 'hand_lens', 'vintage_photo', 'volunteer', 'valentine', 'coin', 'macho', 'guilty', 'music_shop']
    if api_key == "INSERT API KEY HERE":
        print("GET API KEY FROM LINE ID: hertot")
        raise Exception("Wrong API Key")
    print(category_list)
